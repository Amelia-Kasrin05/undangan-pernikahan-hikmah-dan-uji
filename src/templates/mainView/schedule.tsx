        ...
        <div className="w-full h-full flex flex-col gap-5 z-10 relative p-2 pb-4">
          ...
          <div className="relative h-full w-full flex flex-col items-center">
            ...
            >
              ...
              <div
                ref={text3.ref}
                className="absolute top-0 left-full p-4 mt-2 text-gray-400 w-[180px] sm:w-auto sm:whitespace-nowrap"
              >
                <motion.p
                  initial={{ opacity: 0, x: -20 }}
                  animate={text3.isVisible ? { opacity: 1, x: 0 } : { opacity: 0, x: -20 }}
                  transition={{ duration: 0.7, delay: 1 }}
                  className="flex items-center justify-center gap-2 ml-5 text-sm sm:text-base whitespace-nowrap"
                >
                  <img src="/images/ring.png" alt="ring" className="w-8 h-8 sm:w-12 sm:h-12 flex-shrink-0" />
                  09.00 Wib/ Selesai
                </motion.p>
                <motion.div
                  initial={{ opacity: 0 }}
              ...
              {/* content - Resepsi */}
              <div className="absolute top-20 right-full p-4 mt-2 mr-4 text-gray-400 w-[180px] sm:w-auto sm:whitespace-nowrap">
                <motion.p
                  initial={{ opacity: 0, x: 20 }}
                  animate={text3.isVisible ? { opacity: 1, x: 0 } : { opacity: 0, x: 20 }}
                ...
                >
                  11.00 Wib/selesai
                  <img src="/images/reception.png" alt="reception" className="w-8 h-8 sm:w-12 sm:h-12 flex-shrink-0" />
                </motion.p>
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={text3.isVisible ? { opacity: 1 } : { opacity: 0 }}
