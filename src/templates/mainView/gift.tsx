      ...
      >
        ...
        >
          ...
          <span className="font-semibold">
            {isExpanded ? 'Tutup Wedding Gift' : 'Wedding Gift'}
          </span>
          <svg 
            className="w-5 h-5" 
            fill="none" 
          ...
          >
            <div className="flex flex-col gap-8 pt-4">
              ...
              <div className="flex flex-col md:flex-row gap-8 md:gap-12 justify-center items-start w-full px-4">
                ...
                >
                  <motion.img
                    src="/images/bri-logo.jpeg"
                    alt="Logo BRI"
                    className="max-w-[120px] w-full mb-4 rounded-lg"
              ...
              >
                <img
                  ...
                  alt="Amplop"
                  className="w-full max-w-[120px] drop-shadow-lg"
                />
              </motion.div>
